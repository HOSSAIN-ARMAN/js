...
// function test(){
    // VoiceRSS.speech({
    //     key: '0d591ca757msh336e8ddcfe66222p195d17jsn6b67811d97db',
    //     src: 'Hello, world!',
    //     hl: 'en-us',
    //     v: 'Linda',
    //     r: 0, 
...
function tellJoks(joke){
    VoiceRSS.speech({
        key: '6076522cee184dbbb800233a3d4ea68c',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
async function getJoks(){
    const apiUrl = 'https://v2.jokeapi.dev/joke/Any?blacklistFlags=political,racist,sexist,explicit';
    ...
    try{
       ...
       //text-to-speech
       tellJoks(joke)
       //after speech button disable to enable
       toggleButton();
